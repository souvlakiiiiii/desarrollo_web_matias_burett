En la tabla de "Ver listado de adopciones", solo la primera fila se implementó con el click porque la implementación en sí es la misma para cada una de las mascotas que aparezcan. Añadirlas todas sería básicamente copiar y pegar "primeramascota.html" 4 veces para llenar los espacios, por lo que se obvió su implementación.
